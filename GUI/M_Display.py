...
class GB_music(object):
    def setupUi(self, GB_music):
        GB_music.setObjectName("瓜板音乐")
        GB_music.resize(600, 325)
        GB_music.setMinimumSize(QtCore.QSize(600, 325))
        GB_music.setMaximumSize(QtCore.QSize(600, 325))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("ico/瓜板.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        GB_music.setWindowIcon(icon)
        GB_music.setToolTip("")
        self.line = QtWidgets.QFrame(GB_music)
        self.line.setGeometry(QtCore.QRect(125, 0, 10, 325))
        self.line.setFrameShape(QtWidgets.QFrame.VLine)
        self.line.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line.setObjectName("line")
        self.gridLayoutWidget = QtWidgets.QWidget(GB_music)
        self.gridLayoutWidget.setGeometry(QtCore.QRect(140, 35, 320, 255))
        ...
        self.title1.setMaximumSize(QtCore.QSize(70, 30))
        ...
        self.title5.setMaximumSize(QtCore.QSize(70, 30))
        ...
        self.img7.setMaximumSize(QtCore.QSize(70, 70))
        self.img7.setText("")
        ...
        self.img4.setMaximumSize(QtCore.QSize(70, 70))
        self.img4.setText("")
        ...
        self.img1.setMaximumSize(QtCore.QSize(70, 70))
        self.img1.setText("")
        ...
        self.title6.setMaximumSize(QtCore.QSize(70, 30))
        ...
        self.img2.setMaximumSize(QtCore.QSize(70, 70))
        self.img2.setText("")
        ...
        self.img0.setMaximumSize(QtCore.QSize(70, 70))
        self.img0.setText("")
        ...
        self.title0.setMaximumSize(QtCore.QSize(70, 30))
        ...
        self.img5.setMaximumSize(QtCore.QSize(70, 70))
        self.img5.setText("")
        ...
        self.title4.setMaximumSize(QtCore.QSize(70, 30))
        ...
        self.img3.setMaximumSize(QtCore.QSize(70, 70))
        self.img3.setText("")
        ...
        self.title2.setMaximumSize(QtCore.QSize(70, 30))
        ...
        self.title7.setMaximumSize(QtCore.QSize(70, 30))
        ...
        self.title3.setMaximumSize(QtCore.QSize(70, 30))
        ...
        self.img6.setMaximumSize(QtCore.QSize(70, 70))
        self.img6.setText("")
        self.img6.setScaledContents(True)
        self.img6.setObjectName("img6")
        self.grid.addWidget(self.img6, 2, 2, 1, 1)
        self.gridLayoutWidget_2 = QtWidgets.QWidget(GB_music)
        self.gridLayoutWidget_2.setGeometry(QtCore.QRect(140, 295, 320, 25))
        ...
        self.time_line.setMinimumSize(QtCore.QSize(190, 0))
        self.time_line.setMaximumSize(QtCore.QSize(190, 8388607))
        ...
        self.downloads = QtWidgets.QPushButton(GB_music)
        self.downloads.setGeometry(QtCore.QRect(515, 295, 24, 24))
        self.downloads.setMinimumSize(QtCore.QSize(24, 24))
        self.downloads.setMaximumSize(QtCore.QSize(24, 24))
        ...
        self.downloads.setIconSize(QtCore.QSize(24, 24))
        self.downloads.setFlat(True)
        self.downloads.setObjectName("downloads")
        self.localhost = QtWidgets.QPushButton(GB_music)
        self.localhost.setGeometry(QtCore.QRect(515, 295, 24, 24))
        self.localhost.setMinimumSize(QtCore.QSize(24, 24))
        self.localhost.setMaximumSize(QtCore.QSize(24, 24))
        ...
        self.localhost.setIconSize(QtCore.QSize(24, 24))
        self.localhost.setFlat(True)
        self.localhost.setObjectName("localhost")
        self.logo = QtWidgets.QLabel(GB_music)
        self.logo.setGeometry(QtCore.QRect(0, 5, 125, 50))
        self.logo.setMinimumSize(QtCore.QSize(125, 50))
        self.logo.setMaximumSize(QtCore.QSize(125, 50))
        self.logo.setText("")
        self.logo.setPixmap(QtGui.QPixmap("ico/logo.png"))
        self.logo.setObjectName("logo")
        self.myplaylist = QtWidgets.QLabel(GB_music)
        self.myplaylist.setGeometry(QtCore.QRect(0, 55, 40, 20))
        font = QtGui.QFont()
        font.setFamily("华文行楷")
        font.setPointSize(10)
        self.myplaylist.setFont(font)
        self.myplaylist.setObjectName("myplaylist")
        self.new_playlist = QtWidgets.QPushButton(GB_music)
        self.new_playlist.setGeometry(QtCore.QRect(80, 60, 12, 12))  # 添加歌单位置
        self.new_playlist.setMinimumSize(QtCore.QSize(12, 12))
        self.new_playlist.setMaximumSize(QtCore.QSize(12, 12))
        ...
        self.new_playlist.setIconSize(QtCore.QSize(12, 12))          # 垃圾桶位置
        self.new_playlist.setFlat(True)
        self.new_playlist.setObjectName("new_playlist")
        self.delete_playlist = QtWidgets.QPushButton(GB_music)
        self.delete_playlist.setGeometry(QtCore.QRect(100, 60, 12, 12))
        self.delete_playlist.setMinimumSize(QtCore.QSize(12, 12))
        self.delete_playlist.setMaximumSize(QtCore.QSize(12, 12))
        ...
        self.delete_playlist.setIconSize(QtCore.QSize(12, 12))
        self.delete_playlist.setFlat(True)
        self.delete_playlist.setObjectName("delete_playlist")
        self.add_to_playlist = QtWidgets.QPushButton(GB_music)
        self.add_to_playlist.setGeometry(QtCore.QRect(485, 295, 24, 24))   # 搜索框位置
        self.add_to_playlist.setMinimumSize(QtCore.QSize(24, 24))
        self.add_to_playlist.setMaximumSize(QtCore.QSize(24, 24))
        ...
        self.add_to_playlist.setIconSize(QtCore.QSize(24, 24))
        self.add_to_playlist.setFlat(True)
        self.add_to_playlist.setObjectName("add_to_playlist")
        self.layoutWidget = QtWidgets.QWidget(GB_music)
        self.layoutWidget.setGeometry(QtCore.QRect(140, 0, 290, 25))  # 推荐歌单位置
        ...
        self.listview = QtWidgets.QListWidget(GB_music)
        self.listview.setGeometry(QtCore.QRect(465, 15, 135, 275))
        self.listview.setMinimumSize(QtCore.QSize(135, 275))
        self.listview.setMaximumSize(QtCore.QSize(135, 275))
        self.listview.setObjectName("listview")
        self.listview_lable = QtWidgets.QLabel(GB_music)
        self.listview_lable.setGeometry(QtCore.QRect(465, 5, 40, 10))
        font = QtGui.QFont()
        font.setFamily("华文行楷")
        font.setPointSize(10)
        self.listview_lable.setFont(font)
        self.listview_lable.setObjectName("listview_lable")
        self.myplaylist_list = QtWidgets.QListWidget(GB_music)
        self.myplaylist_list.setGeometry(QtCore.QRect(0, 75, 130, 200))
        self.myplaylist_list.setObjectName("myplaylist_list")
        self.disc_title = QtWidgets.QLabel(GB_music)
        self.disc_title.setGeometry(QtCore.QRect(2, 314, 125, 10))
        self.disc_title.setMinimumSize(QtCore.QSize(125, 10))
        self.disc_title.setMaximumSize(QtCore.QSize(125, 10))
        self.disc_title.setText("")
        self.disc_title.setObjectName("disc_title")
        self.disc = QtWidgets.QLabel(GB_music)
        self.disc.setEnabled(True)
        self.disc.setGeometry(QtCore.QRect(0, 280, 32, 32))
        self.disc.setMinimumSize(QtCore.QSize(32, 32))
        self.disc.setMaximumSize(QtCore.QSize(32, 32))
        ...
        self.music_pre = QtWidgets.QPushButton(GB_music)
        self.music_pre.setGeometry(QtCore.QRect(40, 285, 24, 24))
        self.music_pre.setMinimumSize(QtCore.QSize(24, 24))
        self.music_pre.setMaximumSize(QtCore.QSize(24, 24))
        ...
        self.music_pre.setIconSize(QtCore.QSize(24, 24))
        self.music_pre.setFlat(True)
        self.music_pre.setObjectName("music_pre")
        self.music_start_stop = QtWidgets.QPushButton(GB_music)
        self.music_start_stop.setGeometry(QtCore.QRect(70, 285, 24, 24))
        self.music_start_stop.setMinimumSize(QtCore.QSize(24, 24))
        self.music_start_stop.setMaximumSize(QtCore.QSize(24, 24))
        ...
        self.music_start_stop.setIconSize(QtCore.QSize(24, 24))
        self.music_start_stop.setFlat(True)
        self.music_start_stop.setObjectName("music_start_stop")
        self.music_next = QtWidgets.QPushButton(GB_music)
        self.music_next.setGeometry(QtCore.QRect(100, 285, 24, 24))
        self.music_next.setMinimumSize(QtCore.QSize(24, 24))
        self.music_next.setMaximumSize(QtCore.QSize(24, 24))
        ...
        self.music_next.setIconSize(QtCore.QSize(24, 24))
        self.music_next.setFlat(True)
        self.music_next.setObjectName("music_next")
        self.message_label = QtWidgets.QLabel(GB_music)
        self.message_label.setGeometry(QtCore.QRect(510, 3, 85, 10))
        font = QtGui.QFont()
        font.setFamily("华文行楷")
        font.setPointSize(10)
        font.setBold(False)
        ...
        self.song_modle = QtWidgets.QPushButton(GB_music)
        self.song_modle.setGeometry(QtCore.QRect(465, 300, 15, 15))
        self.song_modle.setMinimumSize(QtCore.QSize(15, 15))
        self.song_modle.setMaximumSize(QtCore.QSize(15, 15))
        ...
        self.song_modle.setIconSize(QtCore.QSize(15, 15))
        self.song_modle.setFlat(True)
        self.song_modle.setObjectName("song_modle")

        self.retranslateUi(GB_music)
        QtCore.QMetaObject.connectSlotsByName(GB_music)

    def retranslateUi(self, GB_music):
        _translate = QtCore.QCoreApplication.translate
        GB_music.setWindowTitle(_translate("GB_music", "瓜板音乐"))
        self.title1.setToolTip(_translate("GB_music", "单击"))
        self.title5.setToolTip(_translate("GB_music", "单击"))
        self.img7.setToolTip(_translate("GB_music", "点击下方标题"))
        self.img4.setToolTip(_translate("GB_music", "点击下方标题"))
        self.img1.setToolTip(_translate("GB_music", "点击下方标题"))
        self.title6.setToolTip(_translate("GB_music", "单击"))
        self.img2.setToolTip(_translate("GB_music", "点击下方标题"))
        self.img0.setToolTip(_translate("GB_music", "点击下方标题"))
        self.title0.setToolTip(_translate("GB_music", "单击"))
        self.img5.setToolTip(_translate("GB_music", "点击下方标题"))
        self.title4.setToolTip(_translate("GB_music", "单击"))
        self.img3.setToolTip(_translate("GB_music", "点击下方标题"))
        self.title2.setToolTip(_translate("GB_music", "单击"))
        self.title7.setToolTip(_translate("GB_music", "单击"))
        self.title3.setToolTip(_translate("GB_music", "单击"))
        self.img6.setToolTip(_translate("GB_music", "点击下方标题"))
        self.time_pre.setText(_translate("GB_music", "00:00"))
        self.time_next.setText(_translate("GB_music", "00:00"))
        self.downloads.setToolTip(_translate("GB_music", "下载当前播放歌曲"))
        self.localhost.setToolTip(_translate("GB_music", "导入本地音乐"))
        self.myplaylist.setText(_translate("GB_music", "我的歌单"))
        self.new_playlist.setToolTip(_translate("GB_music", "添加歌单"))
        self.delete_playlist.setToolTip(_translate("GB_music", "删除歌单"))
        self.add_to_playlist.setToolTip(_translate("GB_music", "将当前歌曲添加到歌单中"))
        self.search.setToolTip(_translate("GB_music", "在搜索框中搜索"))
        self.search.setText(_translate("GB_music", "发现音乐"))
        self.search_edit.setPlaceholderText(_translate("GB_music", "乐者，音之所由生也"))
        self.src_choose.setToolTip(_translate("GB_music", "选择音乐源"))
        self.src_choose.setItemText(0, _translate("GB_music", "网易云"))
        self.src_choose.setItemText(1, _translate("GB_music", "QQ音乐"))
        self.listview_lable.setText(_translate("GB_music", "歌单列表"))
        self.music_pre.setToolTip(_translate("GB_music", "上一首"))
        self.music_start_stop.setToolTip(_translate("GB_music", "播放/暂停"))
        self.music_next.setToolTip(_translate("GB_music", "下一首"))
        self.song_modle.setToolTip(_translate("GB_music", "列表循环"))
